...
namespace AzureBatchEndpoint.Controllers
{
    ...
    public class AzureBatchController(ILogger<AzureBatchController> logger, MLService azureMLBatchService) : ControllerBase
    {
        ...
        /// <summary>
        /// Use the RunPrediction with appropriate diamond attributes (4Cs) to get an appraisal. Attribute description https://4cs.gia.edu/en-us/blog/gia-diamond-grading-scales/
        /// </summary>
        /// <remarks>
